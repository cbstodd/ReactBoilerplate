...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    ...
	    Greeter = __webpack_require__(162),
	    MessageForm = __webpack_require__(163);
	
	var firstName = 'Colper';
	var like = 'What do you like?';
	
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: like }), document.getElementById('app'));
	...
	var Greeter = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(MessageForm, { onNewMessage: this.handleNewMessage })
	        );
	    }
	});
	...
	module.exports = {
	    ...
	    resolve: {
	        ...
	        alias: {
	            ...
	            MessageForm: 'public/components/MessageForm.jsx'
	        },
	        extensions: ['', '.js', '.jsx']
	    },
	    module: {
